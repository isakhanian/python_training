...
def test_add_contact(app):
    ...
    app.add_new_user(Group(name="Иван", middlename="Иванович", lastname="Иванов", nickname="Ван", company="Галактика", companyaddress="Планетная улица, 1", homenumber="111-11-11",
...
def test_add_another_contact(app):
    app.login(username="admin", password="secret")
    app.add_new_user(Group(name="Федор", middlename="Федорович", lastname="Федоров", nickname="Фед", company="Вселенная", companyaddress="Красивая улица, 1", homenumber="222-22-22",
